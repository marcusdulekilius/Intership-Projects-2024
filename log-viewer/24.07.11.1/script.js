document.addEventListener('DOMContentLoaded', function () {
    ...
    function populateLogTable(data) {
        ...
        const displayedLogs = data.slice(-selectedLogCount).reverse(); // Reverse the logs before displaying
    ...
    function displayLogEntries(logs) {
        ...
        const selectedLogCount = parseInt(logCountSelect.value);
        const displayedLogs = logs.slice(-selectedLogCount).reverse(); // Reverse the logs before displaying
    ...
    function displayStatistics(data) {
        const selectedLogCount = parseInt(logCountSelect.value);
        const displayedLogs = data.slice(-selectedLogCount).reverse(); // Reverse the logs before processing statistics
